...
#===================================THE MAIN CODE====================================
class MessageSentHandler(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        #--------------------------If the USER ID Is Correct-------------------------
                    ...
                    if message.new_conversation and message.message_parent:
                        ...
                        while end_flag == 0:
                            ...
                            if old_msg.sender_id == userid:
                                ...
                                if old_msg.message_parent:
                                    key2 = old_msg.message_parent
                                else:
                                    end_flag = 1
            ...
            self.response.out.write(template.render('./html/message_sent.html',params))
            #------------------------------------------------------------------------
